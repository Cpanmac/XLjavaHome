...
public class download {
	...
	/*
	 * public void down() { tar.setText(""); File f = new File("src/my/2.txt");
	 * List list = new ArrayList(); try { URL url = new URL(tfd.getText());
	 * Reader in = new InputStreamReader(url.openStream()); Writer out = new
	 ...
	 * l.setText("ni shu ru de  is error"); d.setVisible(true); for(int
	 * index=0;index<list.size();index++) { String
	 * url_my="http://www.xs52.com/xiaoshuo/20/20221/"+list.get(index);
	 * down2(index,url_my); }
	 * 
	 * }
	 */
