...
public class GetJNDI {
	...
	public static Object webLogic10(String mappedName, String className) {
		try {
			...
			env.setProperty(Context.PROVIDER_URL, "t3://" + ejbServerIP + ":"
					+ ejbServerPort);
	...
	public static Object jBoss4(String mappedName) {
		try {
			...
			env.setProperty(Context.PROVIDER_URL, ejbServerIP + ":"
					+ ejbServerPort);
			InitialContext ctx = new InitialContext(env);
	...
	public Object lookup(String jarName, String mappedName, String className) {
		...
		case 4:
			...
			break;
		default:
			daoImpl = ejbServerIP.length() == 0 || ejbServerPort.length() == 0 ? autoLookup(
					jarName, mappedName, className) : initLookup(jarName,
