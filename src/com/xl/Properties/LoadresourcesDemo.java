...
public class LoadresourcesDemo {
	...
	public void test1() throws IOException {
		...
		BufferedInputStream in = (BufferedInputStream) LoadresourcesDemo.class
				.getResourceAsStream(name); // Class类的方法
	...
	public void testClassLoader() throws IOException {
		...
		InputStream in = LoadresourcesDemo.class.getClassLoader()
				.getResourceAsStream("Properties/" + name); // ClassLoader类的方法。
