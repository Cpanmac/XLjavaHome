...
public class 生成年份 {
    public void year() throws IOException {
        BufferedWriter bw = new BufferedWriter(new FileWriter("c:\\Documents and Settings\\Administrator\\桌面\\1.txt"));
        int num = 2013;
        int conut = 0;
    ...
    public void city() throws IOException {
        String[] str = {"武汉市", "黄石市", "襄樊市", "十堰市", "荆州市", "宜昌市", "荆门市", "鄂州市", " 孝感市", "黄冈市", " 咸宁市", "随州市", " 恩施市", "仙桃市", " 潜江市", "天门市"};
        BufferedWriter bw = new BufferedWriter(new FileWriter("c:\\Documents and Settings\\Administrator\\桌面\\1.txt"));
        int num = 0;
        int conut = 0;
        String s;
