...
public class 去掉android命名空间重复 {
    ...
    private String exec(String content) {
        ...
        StringBuilder first = new StringBuilder(content.substring(0, beginIndex));
        // System.out.print(first.toString()); // 输出第一段
        StringBuilder second = new StringBuilder(content.substring(beginIndex, content.length()));
