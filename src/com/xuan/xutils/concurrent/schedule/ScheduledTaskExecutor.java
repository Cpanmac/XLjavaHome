...
public class ScheduledTaskExecutor extends ScheduledThreadPoolExecutor {
     ...
     *
     * @param corePoolSize 线程池中所保留的线程数（包括空闲线程）
     ...
     * @throws IllegalArgumentException 如果 <tt>corePoolSize &lt; 0</tt>
     * @throws NullPointerException     如果 threadFactory 为null
     */
     ...
     * @param handler       由于超出线程范围和队列容量而使执行被阻塞时所使用的处理程序
     * @throws IllegalArgumentException 如果 <tt>corePoolSize &lt; 0</tt>
     * @throws NullPointerException     如果 threadFactory 或者 handler 为null
     */
     ...
     * @throws IllegalArgumentException   如果 period 小于或等于 0
     */
     ...
     * @throws RejectedExecutionException 如果无法安排执行该任务
     * @throws NullPointerException       如果 command 为 null
     * @throws IllegalArgumentException   如果 delay 小于或等于 0
     */
