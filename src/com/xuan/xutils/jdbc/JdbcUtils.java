...
public abstract class JdbcUtils {
     ...
     *
     * @param inSQL     带 "IN" 的 sql 语句, e.g. SELECT * FROM table_name WHERE field_name IN
     * @param inArgs    IN 子句中的所有参数
     * @param otherArgs 其他参数
     * @param processor 处理每次 SQL 执行结果的接口，例如实现中可获取每次查询结果，然后将它们累加
     */
     ...
     *
     * @param str
     * @param keyword         关键字，例如：select
     * @param oppositeKeyword 对应的关键字，例如：from
