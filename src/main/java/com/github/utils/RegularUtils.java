...
public class RegularUtils {
     ...
     * @return 返回boolean
     */
    static public boolean isMatched(String pattern, String reg) {
     ...
     */
    static public List<String> match(String pattern, String reg, int group) throws IllegalGroupIndexException {
