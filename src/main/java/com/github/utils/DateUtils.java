...
public class DateUtils {
     ...
     */
    static public Date str2Date(String strDate, String format) {
        Date date = null;
        SimpleDateFormat sdf = new SimpleDateFormat(format);
        try {
     ...
     */
    @Deprecated
    static public Date str2Date(String strDate) throws TimeMatchFormatException, ParseException {
     ...
     */
    @Deprecated
    static public Date str2DateUnmatch2Null(String strDate) {
        Date date = null;
        try {
