...
public class RegexDemo {
    ...
    */
    ...
    public void group1() {
        ...
        while (m.find()) {
            Print.info("第0组即是所匹配的字符串:" + m.group(0));
            Print.info("第1组即是第1个()内字符串:" + m.group(1));
            Print.info("第2组即是第2个()内字符串:" + m.group(2));
        }
    }
    ...
    public void fun10() {
        ...
        String s = "122";
        Matcher m = p.matcher(s);
        Print.info(m.matches() + ":" + m.group(2));
    }

    @Test
    public void fun11() {
        Pattern p = Pattern.compile("java", Pattern.CASE_INSENSITIVE);
        Print.info("Java".matches("(?i)(java)")); /* (?i)非捕获组:是上面的简写 */
    }
