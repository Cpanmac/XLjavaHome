...
public interface ITestDAO {
    ...
    String FIND_ACCOUNT_BY_ID = "select " + " id as id," + " name as name," + " money as money" + " from account " + " where " + " id = #{id}";
    String FIND_ACCOUNTS_BY_ID = "select " + " id as id," + " name as name," + " money as money" + " from account " + " where " + " id >= #{id}";
    String FIND_USER_BY_ID = "select " + " id as userId," + " name as userName," + " money as userMoney" + " from account " + " where " + " id = #{id}";
